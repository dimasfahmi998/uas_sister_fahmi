        ...
        <div class="container-xl">
            <div class="table-responsive">
                <div class="table-wrapper">
                    ...
                    <form action="aksi_tambah_hp.php" method="POST">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name_field" name="jenis" required>
                        </div>
                        <div class="mb-3">
                            <label for="name_field" class="form-label">Harga</label>
                            <input type="text" class="form-control" id="name_field" name="harga" required>
                        </div>
